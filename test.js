var _cf = _cf || [],
	bmak = {
      ...
      //return r = null != window["document"]["documentElement"]["getAttribute"]("selenium") ? "1" : "0", [a, t, e, n, o, m, r]["join"](",")
		...
		forminfo: function() {
      //return  '0,-1,0,0,1420,1420,0;0,-1,0,0,1958,1958,0;';
      ...
      //console.log('bmak["ckie"]===>', bmak["ckie"]);
		...
		bpd: function() {
			...
			try {
				...
				var k = bmak["ke_vel"] + bmak["me_vel"] + bmak["doe_vel"] + bmak["dme_vel"] + bmak["te_vel"] + bmak["pe_vel"],
					...
					l = bmak["pi"](bmak["d2"] / 6),
					u = bmak["fas"](),
					_ = [bmak["ke_vel"] + 1, bmak["me_vel"], bmak["te_vel"], bmak["doe_vel"], bmak["dme_vel"], bmak["pe_vel"], k, t, bmak["init_time"], bmak["start_ts"], bmak["fpcf"]["td"], bmak["d2"], bmak["ke_cnt"], bmak["me_cnt"], l, bmak["pe_cnt"], bmak["te_cnt"], s, bmak["ta"], bmak["n_ck"], e, bmak["ab"](e), bmak["fpcf"]["rVal"], bmak["fpcf"]["rCFP"], u],
					f = _["join"](","),
        ...
        get(target, propKey, receiver) {
            ...
            if(typeof  origMethod ==='function') {
              return function (...args) {
                ...
                console.info(propKey + JSON.stringify(args)
